    ...
    <div class="grid grid-cols-12 gap-y-[70px] xl:gap-x-[70px] py-[70px] px-[15px] xl:px-[260px]">
            ...
            <div>
                ...
                @foreach($menus as $menu)
                    <div class="flex items-center mb-[15px]" x-data="{ hover : false }" x-on:mouseover="hover = true" x-on:mouseover.away="hover = false">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-[15px] min-w-[15px] mr-[5px] transition-all ease-in-out duration-300" fill="none" viewBox="0 0 24 24" x-bind:stroke="hover ? '#A07D3F' : '#FFFFFF'">
        ...
        <div class="col-span-6 xl:col-span-2 flex">
            <div>
                ...
                @while($service->have_posts())
                    {{ $service->the_post() }}
                    <div class="flex items-center mb-[15px]" x-data="{ hover : false }" x-on:mouseover="hover = true" x-on:mouseover.away="hover = false">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-[15px] min-w-[15px] transition-all ease-in-out duration-300" fill="none" viewBox="0 0 24 24" x-bind:stroke="hover ? '#A07D3F' : '#FFFFFF'">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                        </svg>
        ...
        <div class="col-span-12 xl:col-span-3">
            ...
            <div class="flex pb-[15px]">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-[15px] min-w-[15px] mr-[30px]" viewBox="0 0 20 20" fill="#ffffff" stroke="#ffffff">
            ...
            <div class="flex pb-[15px]">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-[15px] min-w-[15px] mr-[30px]" viewBox="0 0 24 24" fill="#ffffff" stroke="#000000">
...
<div class="flex justify-between py-[30px] px-[15px] xl:px-[260px]">
    ...
    <div class="flex font-secondary text-white text-[14px]">
        ...
        <a class="transition-all ease-in-out duration-300 hover:text-cape-palliser" href="{{ get_field('footer_copyright_2_url', 'option') }}">
