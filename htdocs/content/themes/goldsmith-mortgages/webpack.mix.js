...
mix.sass('assets/sass/testimonial.scss', 'dist/css/testimonial.css');
mix.js('assets/js/testimonial.js', 'dist/js/testimonial.js');

mix.js('assets/js/contact.js', 'dist/js/contact.js');

mix.js('assets/js/map.js', 'dist/js/map.js');
